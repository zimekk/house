          ...
          : level === "chimney"
            ...
            : level === "ground-floor-windows"
              ? {
                  ...
                  d: [
                    draw(
                      ((a, w) => rect(shift(a, [0, 0]), shift(a, [0.48, w])))(
                        shift(bryla[1], [-11.3 - 0.48, -2.7 + 0.48]),
                        1,
                      ),
                    ),
                    draw(
                      ((a, w) => rect(shift(a, [-0.48, -w]), shift(a, [0, 0])))(
                        shift(bryla[1], [-4, 1.9]),
                        0.8,
                      ),
                    ),
                    draw(
                      ((a, w) => rect(shift(a, [0, -w]), shift(a, [0.48, 0])))(
                        shift(bryla[2], [-0.48, -0.48]),
                        2.2,
                      ),
                    ),
                    ...
                    draw(
                      ((a, w) => rect(shift(a, [-w, 0]), shift(a, [0, 0.48])))(
                        shift(bryla[2], [-0.48, -0.48]),
                        2,
                      ),
                    ),
                    ...
                    draw(
                      ((a, w) => rect(shift(a, [0, 0]), shift(a, [w, 0.48])))(
                        shift(bryla[3], [
                    ...
                    draw(
                      ((a, w) => rect(shift(a, [0, -w]), shift(a, [0.1, 0])))(
              ...
              : level === "garage-doors"
                ? {
                    ...
                    d: [
                      draw(
                        ((a, w) => rect(shift(a, [0, 0]), shift(a, [0.1, w])))(
                          shift(bryla[1], [
                            -15.28 - 4.52 - 1.2,
                            -2.7 + 0.48 + 0.6,
                          ]),
                    ...
                    ? {
                        ...
                        d: [
                          ...
                          draw(
                            ((a, w) =>
                              rect(shift(a, [-w, 0]), shift(a, [0, 0.48])))(
                              shift(bryla[1], [-0.48 - 2.9 - 1.7 - 1.2, 0]),
                              1.1,
                            ),
                          ), // fixme
                        ].join(" "),
