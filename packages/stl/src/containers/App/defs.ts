...
export default (level: string, x = 0, y = 0, selected: string[] = []) => {
  // const gabinet = points(x, y).gabinet();
          ...
          ? {
              ...
              d: [
                ...
                hole([
                  garderoba3[0],
                  garderoba3[1],
                  shift(garderoba3[2], [0, -1.84]),
                  shift(garderoba3[2], [0.7, -1.84]),
                  shift(garderoba3[2], [0.7, 0]),
                  garderoba3[3],
                ]),
                hole([
                  lazienka3[0],
                  lazienka3[1],
                  lazienka3[2],
                  shift(lazienka3[3], [0.7, 0]),
                  shift(lazienka3[3], [0.7, -2]),
                  shift(lazienka3[3], [0, -2]),
                ]),
                hole(gabinet2),
                hole(pralnia),
                hole([
