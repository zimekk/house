        ...
        : level === "attic"
          ...
          : level === "ground-floor-windows"
            ? {
                ...
                d: [
                  draw(
                    ((a) => rect(shift(a, [0, 0]), shift(a, [2.1, 0.48])))(
                      shift(bryla[3], [0.48 + 3 + 2, -0.48]),
                    ),
                  ), // fixme
                  draw(
                    ((a) => rect(shift(a, [0, -2.2]), shift(a, [0.48, 0])))(
                      shift(bryla[2], [-0.48, -0.48]),
                    ),
                  ),
                  draw(
                  ...
                  draw(
                    ((a) => rect(shift(a, [-2.1, 0]), shift(a, [0, 0.48])))(
                      shift(bryla[2], [-0.48, -0.48]),
                    ),
                  ),
                  draw(
                    ((a) => rect(shift(a, [-2.1, 0]), shift(a, [0, 0.48])))(
                      shift(bryla[2], [-0.48 - 2.1, -0.48]),
                    ),
                  ),
                  draw(
                    ((a) => rect(shift(a, [-2.1, 0]), shift(a, [0, 0.48])))(
                      shift(bryla[2], [-0.48 - 2.1 - 2.1 - 0.48, -0.48]),
                    ),
                  ),
                  draw(
                    ((a) => rect(shift(a, [-2.1, 0]), shift(a, [0, 0.48])))(
                      shift(bryla[2], [-0.48 - 2.1 - 2.1 - 2.1 - 0.48, -0.48]),
                    ),
                  ),
                ].join(" "),
              }
